...
W aneksie zaprezentowano tabelaryczne rozkłady wybranych wskaźników przedstawionych w raporcie, ale dla ogółu absolwentów, którzy w roku szkolnym `r rocznik` ukończyli technika w województwie, w którym znajduje się Państwa szkoła oraz w całym kraju.
...
* Część przepracowanego okresu - procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów techników z województwa `r woj$odmiany[[1]]$nazwa_dop`.
...
* Formy wykonywania pracy w grudniu `r params$rok` roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów techników z województwa `r woj$odmiany[[1]]$nazwa_dop`.
...
* Formy wykonywania pracy w grudniu `r params$rok` roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów techników z całego kraju.
...
Procentowy udział grup wyróżnionych ze względu na część okresu, w ciągu którego byli zarejestrowani jako bezrobotni, wśród absolwentów techników z województwa `r woj$odmiany[[1]]$nazwa_dop`.
