...
# 5. Aneks: wyniki dla absolwentów szkół specjalnych przysposabiających do pracy z województwa i z całego kraju
...
W aneksie zaprezentowano tabelaryczne rozkłady wybranych wskaźników przedstawionych w raporcie, ale dla ogółu absolwentów, którzy w roku szkolnym `r rocznik` ukończyli szkoły specjalne przysposabiające do pracy w województwie, w którym znajduje się Państwa szkoła oraz w całym kraju.
...
2. Praca po ukończeniu szkoły specjalnej przysposabiającej do pracy w okresie od września do grudnia `r params$rok` roku
    ...
    a) województwo `r woj$odmiany[[1]]$nazwa`
    
* Część przepracowanego okresu - procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów szkół specjalnych przysposabiających do pracy z województwa `r woj$odmiany[[1]]$nazwa_dop`.
...
* Formy wykonywania pracy w grudniu `r params$rok` roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów szkół specjalnych przysposabiających do pracy z województwa `r woj$odmiany[[1]]$nazwa_dop`.
...
* Formy wykonywania pracy w grudniu `r params$rok` roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów szkół specjalnych przysposabiających do pracy z całego kraju.
...
Procentowy udział grup wyróżnionych ze względu na część okresu, w ciągu którego byli zarejestrowani jako bezrobotni, wśród absolwentów szkół specjalnych przysposabiających do pracy z województwa `r woj$odmiany[[1]]$nazwa_dop`.
