...
*Raport roczny z monitoringu karier absolwentów, których szkołą ukończoną w `r params$rok` roku była `r szk$dane_szkoly[[1]]$nazwa`. Monitoring na podstawie danych rejestrowych. Warszawa: Instytut Badań Edukacyjnych, 2023.*
...
# 3. Praca po ukończeniu szkoły specjalnej przysposabiającej do pracy
...
# 5. Aneks: wyniki dla absolwentów szkół specjalnych przysposabiających do pracy `r ifelse(woj$l_abs[[1]] < progLiczebnosci, paste0(""), paste0("z województwa i "))`z całego kraju
...
W aneksie zaprezentowano tabelaryczne rozkłady wybranych wskaźników przedstawionych w raporcie, ale dla ogółu absolwentów, którzy w roku szkolnym `r rocznik` ukończyli szkoły specjalne przysposabiające do pracy `r ifelse(woj$l_abs[[1]] < progLiczebnosci, paste0(""), paste0("w województwie, w którym znajduje się Państwa szkoła oraz "))`w całym kraju.
...
2. Praca po ukończeniu szkoły specjalnej przysposabiającej do pracy w okresie od września do grudnia `r params$rok` roku

```{r, echo=FALSE, message=FALSE, error=FALSE, warning=FALSE, results='asis', fig.align=wyrownanieTabWykr}
if (woj$l_abs[[1]] < progLiczebnosci | woj$Z4_ucz[[1]]$n < progLiczebnosci) {
  cat("Procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów szkół specjalnych przysposabiających do pracy z całego kraju.\n\n",
  ...
  cat("  b) Formy wykonywania pracy w grudniu ",
      params$rok,
      " roku\n\n",
      "Procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów szkół specjalnych przysposabiających do pracy z całego kraju.\n\n")
...
if (woj$l_abs[[1]] >= progLiczebnosci & woj$Z4_ucz[[1]]$n >= progLiczebnosci) {
  cat("  a) województwo ",
      woj$odmiany[[1]]$nazwa,
      "\n\n* Część przepracowanego okresu - procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów szkół specjalnych przysposabiających do pracy z województwa ",
  ...
  tabelka = tabelka %>% 
    ...
    kable_styling(position = wyrownanieTabWykr,
                  ...
                  full_width = FALSE,
                  repeat_header_text = "(ciąg dalszy tabeli)") %>%
    add_header_above(c(" ", "Absolwenci szkół specjalnych\nz województwa kontynuujący naukę" = 1, "Absolwenci Absolwenci szkół specjalnych\nz województwa niekontynuujący nauki" = 1),
                     align = c("l", "c", "c"))
  ...
  cat("\n\n* Formy wykonywania pracy w grudniu ",
      params$rok,
      " roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów szkół specjalnych przysposabiających do pracy z województwa ",
      woj$odmiany[[1]]$nazwa_dop,
      "\n\n",
      sep = "")
  ...
  cat("\n\n  b) cały kraj\n\n* Część przepracowanego okresu - procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów szkół specjalnych przysposabiających do pracy z całego kraju.\n\n")
  ...
  cat("\n\n* Formy wykonywania pracy w grudniu ",
      params$rok,
      " roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów szkół specjalnych przysposabiających do pracy z całego kraju.\n\n",
      sep = "")
...
3. Bezrobocie rejestrowane od września do grudnia `r params$rok` roku

```{r, echo=FALSE, message=FALSE, error=FALSE, warning=FALSE, results='asis', fig.align=wyrownanieTabWykr}
if (woj$l_abs[[1]] < progLiczebnosci | sum(woj$B2_bezrob[[1]]$n) < progLiczebnosci) {
  cat("Procentowy udział grup wyróżnionych ze względu na część okresu, w ciągu którego byli zarejestrowani jako bezrobotni, wśród absolwentów szkół specjalnych przysposabiających do pracy z całego kraju.")
  ...
  cat("  a) województwo ",
      woj$odmiany[[1]]$nazwa,
      "\n\nProcentowy udział grup wyróżnionych ze względu na część okresu, w ciągu którego byli zarejestrowani jako bezrobotni, wśród absolwentów szkół specjalnych przysposabiających do pracy z województwa ",
      woj$odmiany[[1]]$nazwa_dop,
      ".\n\n",
      sep = "")
