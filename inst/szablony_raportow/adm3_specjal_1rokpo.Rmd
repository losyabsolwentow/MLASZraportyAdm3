...
if (min(szkoly_month$n) >= progLiczebnosci) {
  ...
  wykres = wave_chart(tab_szk,
    ...
    scale_x_continuous(n.breaks = 6,
                       labels = c("7" = "lip", "8" = "sie", "9" = "wrz", "10" = "paź", "11" = "lis", "12" = "gru"))
...
# 5. Aneks: wyniki dla absolwentów szkół specjalnych przysposabiających do pracy z całego kraju
...
2. Praca po ukończeniu szkoły specjalnyej przysposabiającej do pracy w okresie od września do grudnia `r params$rok` roku
