...
cat(
  "**STRONA TESTOWA - nie bęzdzie wyświetlana we właściwym raporcie (a przynajmniej nie powinna być)\n**",
  "ID RSPO szkoły: ",
  szk$id_szk[[1]],
  "\nGrupa odniesienia: ",
...
# 6. Aneks: wyniki dla absolwentów branżowych szkół I stopnia z województwa i z całego kraju
...
W aneksie zaprezentowano tabelaryczne rozkłady wybranych wskaźników przedstawionych w raporcie, ale dla ogółu absolwentów, którzy w roku szkolnym `r rocznik` ukończyli branżowe szkoły I stopnia (BS I) w województwie, w którym znajduje się Państwa szkoła oraz w całym kraju.
...
* Część przepracowanego okresu - procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów branżowych szkół I stopnia z województwa `r woj$odmiany[[1]]$nazwa_dop`.
...
* Formy wykonywania pracy w grudniu `r params$rok` roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów branżowych szkół I stopnia z województwa `r woj$odmiany[[1]]$nazwa_dop`.
...
* Formy wykonywania pracy w grudniu `r params$rok` roku - procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów branżowych szkół I stopnia z całego kraju.
...
Procentowy udział grup wyróżnionych ze względu na część okresu, w ciągu którego byli zarejestrowani jako bezrobotni, wśród absolwentów branżowych szkół I stopnia z województwa `r woj$odmiany[[1]]$nazwa_dop`.
